...
dc_dismsemin: bin
	cd src; gcc -std=c99 -g -D THREADS=$(THREADS) -Wall $(targets) main.c \
		...
		-D REDUCTION_VR -D DISSIM_MSE -D FDISMODE_MINDIST \
...
dc_dismsesum: bin
	cd src; gcc -std=c99 -g -D THREADS=$(THREADS) -Wall $(targets) main.c \
		-D MAX_SOL_SIZE=$(SMALL_SOL_SIZE) -D MAX_FACILITIES=$(SMALL_N) -D MAX_CLIENTS=$(SMALL_M) \
		-D LOCAL_SEARCH -D NDEBUG \
		-D REDUCTION_VR -D DISSIM_MSE -D FDISMODE_SUMOFDELTAS \
		-D HEAP_PARTITION=$(SMALL_HEAP_PARITION) \
...
dc_dishaumin: bin
	cd src; gcc -std=c99 -g -D THREADS=$(THREADS) -Wall $(targets) main.c \
		-D MAX_SOL_SIZE=$(SMALL_SOL_SIZE) -D MAX_FACILITIES=$(SMALL_N) -D MAX_CLIENTS=$(SMALL_M) \
		-D LOCAL_SEARCH -D NDEBUG \
		-D REDUCTION_VR -D DISSIM_HAUSDORFF -D FDISMODE_MINDIST \
		-D HEAP_PARTITION=$(SMALL_HEAP_PARITION) \
...
dc_dishausum: bin
	cd src; gcc -std=c99 -g -D THREADS=$(THREADS) -Wall $(targets) main.c \
		-D MAX_SOL_SIZE=$(SMALL_SOL_SIZE) -D MAX_FACILITIES=$(SMALL_N) -D MAX_CLIENTS=$(SMALL_M) \
		-D LOCAL_SEARCH -D NDEBUG \
		-D REDUCTION_VR -D DISSIM_HAUSDORFF -D FDISMODE_SUMOFDELTAS \
		-D HEAP_PARTITION=$(SMALL_HEAP_PARITION) \
...
dc_discli: bin
	cd src; gcc -std=c99 -g -D THREADS=$(THREADS) -Wall $(targets) main.c \
		-D MAX_SOL_SIZE=$(SMALL_SOL_SIZE) -D MAX_FACILITIES=$(SMALL_N) -D MAX_CLIENTS=$(SMALL_M) \
		-D LOCAL_SEARCH -D NDEBUG \
		-D REDUCTION_VR -D DISSIM_CLIENTDELTA \
		-D HEAP_PARTITION=$(SMALL_HEAP_PARITION) \
